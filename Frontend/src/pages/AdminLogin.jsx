    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Update AuthContext with admin user data
                console.log("Updating AuthContext with user:", data.user);
                setUser(data.user);
                setIsAuthenticated(true);

                console.log("AuthContext updated, redirecting to admin dashboard...");
            ...
            <div className="max-w-md w-full space-y-8">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-300">
                        Access the Garissa E-commerce Admin Dashboard
                    </p>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="mt-6 p-4 bg-gray-800 rounded-lg">
                        ...
                        <div className="text-sm text-gray-400">
                            <p><strong>Email:</strong> admin@garissa.com</p>
